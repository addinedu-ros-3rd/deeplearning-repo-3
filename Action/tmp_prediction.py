...
def action_cam(ret, img):
    ...
    cv2.putText(img, f'{status} 1', (0, 25), cv2.FONT_HERSHEY_COMPLEX, 1.0, (0, 0, 255), 1)
    cv2.imshow('camera', img)
            
    # print(status)
    # cv2.putText(img, f'{status}', (0, 25), cv2.FONT_HERSHEY_COMPLEX, 1.0, (0, 0, 255), 1)
...
# with open('../log/action_log.json', 'w') as f:
...
if __name__ == "__main__":    
    # cap = cv2.VideoCapture('/home/jun/dev_ws/Projects/DL_Project/data/action_data/test_data/test_data_0.MOV')  
    ...
    with open('../log/action_log1.json', 'w') as f:
        json.dump(seq, f, ensure_ascii=False, indent=4)            
    cap.release()
    cv2.destroyAllWindows()